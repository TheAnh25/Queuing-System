...
const NavbarDashboard = () => {
  return (
    <>
      {" "}
      <div className="w-[200px] h-[810px] bg-[#FFFFFF] flex flex-col items-center gap-[54px] rounded-l-2xl">
        <NavLink to="/">
          <div className="pt-8">
          ...
          <div className="flex flex-col gap-[6px]">
            ...
            <NavLink
              ...
              <div className="flex gap-2 h-12 items-center  px-3 ">
                ...
                <div className=" w-20 h-6 font-semibold  text-base  flex-none order-1 flex-grow-0 left-11">
                  <span>Dashboard</span>
                </div>
              </div>
            </NavLink>
            ...
            {/* Dịch vụ */}
            <div className="flex gap-2 h-12 items-center top-[258px]  px-3 ">
              <div className=" w-5 h-5 ">
                <svg
                  width="22"
                  height="20"
            ...
            {/* Cấp số */}
            <div className="flex gap-2 h-12 items-center top-[312px]  px-3 ">
              <div className=" w-5 h-5 ">
                <svg
                  width="20"
                  height="20"
            ...
            {/* Báo cáo */}
            <div className="flex gap-2 h-12 items-center top-[366px]  px-3 ">
              <div className=" w-5 h-5 ">
                <svg
                  width="18"
                  height="20"
